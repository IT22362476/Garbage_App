...
// Add a new vehicle
// Add a new vehicle (admin or collector only)
router.post("/addVehicle", authorizeRoles("admin"), async (req, res) => {
  try {
...
// Update a vehicle by ID (admin or collector only)
router.put("/updateVehicle/:id", authorizeRoles("admin"), async (req, res) => {
  const { id } = req.params;
